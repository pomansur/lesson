...
Guzzle is made available under the MIT License (MIT). Please see [License File](lesson/system/library/yascaner/vendor/guzzlehttp/promises/LICENSE) for more information.
